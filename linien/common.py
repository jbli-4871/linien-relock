...
MAX_ZOOM = 10 ### New variable to remove 
...
def get_lock_point(error_signal, x0, x1, final_zoom_factor=1.5):
    ...
    calculated_zoom = N_POINTS / (idxs[1] - idxs[0]) / final_zoom_factor
    
    # Account for narrow lines
    target_zoom = min(calculated_zoom, MAX_ZOOM)
