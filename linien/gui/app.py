...
class QTApp(QtCore.QObject):
    ...
    def shutdown(self):
        # Set ANALOG OUT 2 to 0 on all GeneralPanel instances before shutdown
        for instance in CustomWidget.instances:
            try:
                from linien.gui.ui.general_panel import GeneralPanel
                if isinstance(instance, GeneralPanel):
                    instance.parameters.analog_out_2.value = 0
                    instance.control.write_data()
            except Exception:
                pass
