...
with open('requirements_gui') as fh:
...
setuptools.setup(
    ...
    install_requires=requirements, #### THIS IS DEPRECATED FUNCTIONALITY, MUST USE PIP TO INSTALL DEPENDENCIES, CANNOT USE SETUPTOOLS
    package_data={
